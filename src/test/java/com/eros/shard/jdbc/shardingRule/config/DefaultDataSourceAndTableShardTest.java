 ...
 *
 */
public class DefaultDataSourceAndTableShardTest extends ShardJdbcDataSource implements ShardingRuleConfigTest {

    private final static Logger logger = LoggerFactory.getLogger(DefaultDataSourceAndTableShardTest.class);
...
//        shardingRuleConfig.setEncryptRuleConfig();
    ...
    public static void main(String[] args) {
        DefaultDataSourceAndTableShardTest defaultDataSourceTest = new DefaultDataSourceAndTableShardTest();
